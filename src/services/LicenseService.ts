export const LicenseService = {
	...
	getLicensesWithOrdersSmall() {
		return Promise.resolve(this.getLicensesWithOrdersData().slice(0, 10));
	},

	getLicensesWithOrders() {
		return Promise.resolve(this.getLicensesWithOrdersData());
	},
};
